...
| 27 | [SUE — Swappable Unit of Execution](docs/27-sue-spec.md) | Model driver contract for both roles (inference + ontic); `lucid_model_roles` registry; per-model tables with native dimensions; swap protocol; rollback |
