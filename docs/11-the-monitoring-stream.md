...
The monitoring stream is a parallel attentional state channel. A compromised system cannot reliably assess its own reasoning quality. The monitoring stream watches dynamics, not content: it is concerned with how the system is moving, not what it is thinking about.
