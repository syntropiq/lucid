...
| Mesh isolation | Peer contact rate near zero; centroid advertisement unreceived | Check VortexMesh peer connectivity; relay health; keypair authentication state |
