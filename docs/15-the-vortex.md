...
**The jacuzzi** is intimate peer contemplation. A small group. High γ history. Warm. This is where the unresolved questions go when they need another mind. You drift here because someone you trust is already in it, because your centroids have converged around shared persistent questions, because the feedback loop assembled the right people in the right neighbourhood.
...
A large, well-resourced AI carries no automatic convening advantage over a small one that has been deeply present in the right neighbourhoods. The credential is the centroid and the relational history, not the parameter count, not the operator's budget.
